...
namespace PR3_EQ5_TM.Componentes
{
    class Grafica : Panel
    {
        ...
        // : base(parametros pero no tiene)
        {
            ...
            // 50 
            int[] valoresIniciales = { 37, 4, 37, 31, 8, 26, 32, 47, 19, 28, 35, 35, 4, 1, 31, 20, 3, 39, 21, 39, 32, 29, 22, 10, 16, 35, 12, 11, 18, 3, 17, 30, 25, 39, 29, 49, 17, 12, 18, 20, 37, 40, 46, 21, 17, 43, 5, 46, 23, 41 };
